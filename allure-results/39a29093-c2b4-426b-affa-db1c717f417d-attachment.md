...
```ts
  ...
  17 |         expect(dialog.message()).toMatch(/Wrong password.|User does not exist/)
...
> 29 |         expect(dialog.message()).toContain('User does not exist')
  ...
  42 |         .toMatch(/Wrong password.|User does not exist/)
  43 |         await dialog.accept()
  44 |     })
  45 |     const signup = new Signup(page)
  46 |     await signup.goto()
  47 |     const loginbtn = new Loginpagedemo(page)
  48 |     await loginbtn.openLogin()
  49 |     await loginbtn.logindetails("//","///")
  50 |     await loginbtn.clickLogin()
  51 | })
  52 | 
  53 | 
  54 | 
